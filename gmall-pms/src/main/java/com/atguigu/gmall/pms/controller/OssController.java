...
public class OssController {
    ...
    public Resp<Object> policy() throws UnsupportedEncodingException {
        ...
        String accessId = "LTAI4Fri9WgDvT5gdhpt7fKr"; // 请填写您的AccessKeyId。
        String accessKey = "JEhEwwrW2aZsuW6c0mjFWmhND9rplW"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "ggmal"; // 请填写您的 bucketname 。
